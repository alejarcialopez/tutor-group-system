...
.. code-block:: bash
    ...
    $ git clone git@github.com:uisautomation/tutor_group_system.git
    $ cd tutor_group_system
    $ git remote set-url origin --push git@github.com:$USER/tutor_group_system.git
...
.. code-block:: bash
    ...
    $ git remote add $USER git@github.com:$USER/tutor_group_system.git
...
:py:class:`tutor_group_system_project.settings.developer` settings,
