"""
The :py:mod:`tutor_group_system_project.settings_testsuite` module contains settings which are
...
#: when running tests.
TEST_RUNNER = 'tutor_group_system_project.test.runner.BufferedDiscoverRunner'
